...
int strtGme();
int screRnd(int,int[5]);
void dsplScn();
void dspSbSn(int[5],int[16],int[16]);
...
void dspSbSn(int d[6], int p1s[16], int p2s[16]){
    #ifdef _WIN32
        system("CLS"); //clear console for Windows
    #endif
    #ifndef test
