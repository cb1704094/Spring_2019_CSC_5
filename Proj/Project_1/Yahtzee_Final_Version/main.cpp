 ...
 * File:   main.cpp
 * Author: Chad Bonnett
 * Purpose: Yahtzee Final version
 * Created on April 14, 2019, 10:13 PM
 */
...
int startGam();
int scrRnd(int,int[5]);
int dspScrn();
int dspSScn(int[5],int[16],int[16]);
...
int doRound(int round, int player, int pScore[16], int p1s[16], int p2s[16]){
 ...
 //Output the game statistics to the screens
int dspScrn(){
...
int dspSScn(int d[6], int p1s[16], int p2s[16]){
